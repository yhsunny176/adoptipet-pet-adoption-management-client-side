                        ...
                        <div className="mt-6 space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <button
                                    ...
                                    className="w-full inline-flex justify-center items-center px-4 py-2 rounded-lg text-md border border-gray-light font-medium text-gray-700 bg-white hover:shadow-sm cursor-pointer transition-all duration-600 ease-in-out">
                                ...
                                <button
                                    ...
                                    className="w-full inline-flex justify-center items-center px-4 py-2 rounded-lg text-md border border-gray-light font-medium text-black-base bg-base-white hover:shadow-sm cursor-pointer transition-all duration-600 ease-in-out">
